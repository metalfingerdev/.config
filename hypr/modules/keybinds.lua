...
local spotify     = "kitty --class floating -- spotify_player"
local calendar    = "kitty --class floating -- calcurse"
local network     = "kitty --class floating -- impala"
local volume      = "kitty --class floating -- pulsemixer"
local bluetooth   = "kitty --class floating -- bluetuith"
local system      = "kitty --class floating -- btop --force-utf"
local refresh     =
